  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white pt-20 sm:pt-28 pb-16 px-3 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-5 sm:space-y-6">
          ...
          {mobileNavOpen && (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2.5 scrollbar-none">
                ...
                {/* Testimonials */}
                <button
                  onClick={() => { setActiveTab('testimonials'); setMobileNavOpen && setMobileNavOpen(false); }}
                  className={`w-full px-4 py-3.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-3 cursor-pointer text-left ${activeTab === 'testimonials'
                      ? 'bg-blue-600/90 text-white shadow-lg shadow-blue-500/25'
                      : 'bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/40 dark:border-slate-800/40 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white'
                    }`}
                >
                  <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${activeTab === 'testimonials' ? 'bg-white/20 text-white' : 'bg-blue-500/10 text-blue-600 dark:text-sky-400'
                    }`}>
                    <MessageSquareQuote className="w-5 h-5" />
                  </div>
                  <span className="truncate flex-1 font-extrabold text-sm">Testimonials</span>
                </button>
              </div>
            </motion.div>
          )}
        ...
        <div className="hidden sm:flex items-center gap-1 sm:gap-1.5 xl:gap-2 overflow-x-auto pb-1.5 scrollbar-none w-full min-w-0">
          {/* Members */}
          <button
            onClick={() => setActiveTab('members')}
            title="Members Management"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'members'
          ...
          >
            ...
            <span className={`px-1.5 py-0.5 rounded-full text-[10px] font-black min-w-[18px] text-center ${activeTab === 'members' ? 'bg-white/20 text-white' : 'bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300'
              }`}>
              {membersList.length}
            </span>
            {pendingApplications.length > 0 && (
          ...
          <button
            ...
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'events'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
            ...
            <span className={`px-1.5 py-0.5 rounded-full text-[10px] min-w-[18px] text-center font-bold ${activeTab === 'events' ? 'bg-white/20 text-white font-black' : 'bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300'
              }`}>
              {eventsList.length}
            </span>
          </button>
          ...
          <button
            ...
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'forms'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
            ...
            {activeTab === 'forms' ? (
              ...
              <span className="hidden xl:inline">Form Builder</span>
            )}
          </button>
          ...
          <button
            ...
            title="Contact & Feedbacks"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'feedbacks'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
            ...
            {activeTab === 'feedbacks' ? (
              ...
              <span className="hidden xl:inline">Feedbacks</span>
            )}
            {(contactFeedbacksList.filter((f) => f.status === 'pending' || f.status === 'unread').length +
              eventFeedbacksList.filter((f) => f.status === 'pending' || f.status === 'unread').length) > 0 && (
          ...
          <button
            ...
            title="Event Gallery"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'gallery'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
          ...
          <button
            ...
            title="Our Team"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'team'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
          ...
          <button
            ...
            title="Emails"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'emails'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
          ...
          <button
            ...
            title="Chatbot FAQs"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'chatbot'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
          ...
          <button
            ...
            title="Testimonials"
            className={`flex-1 min-w-fit justify-center px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-2xl text-xs font-extrabold transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${activeTab === 'testimonials'
                ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30'
                : 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-700'
              }`}
          >
        ...
        {/* Tab Content 9: Testimonials Management */}
        {activeTab === 'testimonials' && (
