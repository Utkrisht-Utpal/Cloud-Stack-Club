  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        {isFormOpen ? (
          <form onSubmit={handleSubmit} className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-blue-500/30 shadow-lg space-y-4">
                  ...
                  return (
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                        isSelected
                          ? `${cfg.bg} ${cfg.text} ${cfg.border} ring-2 ring-blue-500/30 font-black shadow-sm`
                ...
                >
                  ...
                  <div className="flex items-center gap-1 shrink-0 pt-0.5">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-xl text-slate-500 hover:text-blue-600 hover:bg-blue-500/10 dark:hover:text-sky-400 transition-colors"
                      title="Edit Notice"
                    >
    ...
    {/* Themed Delete Confirmation Modal (Identical to Delete Event Modal) */}
    <ConfirmModal
